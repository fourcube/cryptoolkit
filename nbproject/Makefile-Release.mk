...
${OBJECTDIR}/xor.o: xor.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/xor.o xor.c
...
${TESTDIR}/tests/xor_test.o: tests/xor_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/xor_test.o tests/xor_test.c
...
${OBJECTDIR}/xor_nomain.o: ${OBJECTDIR}/xor.o xor.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/xor_nomain.o xor.c;\
	else  \
